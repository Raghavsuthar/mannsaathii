...
object LocaleHelper {
    ...
    val englishStrings = mapOf(
        ...
        "activities_completed_today" to "Activities enjoyed today",
        "recommended_today" to "Today's Gentle Activity",
        "tap_to_start" to "Tap to Start",
        "well_done_title" to "Wonderful effort! ✨",
        "next_activity" to "Next Activity",
        "try_another_activity" to "Explore More Activities",
        "i_remember_ready" to "I looked at them! Ready ✨",
        "what_did_you_see" to "Which item was on the tray?",
        "all_activities" to "All Activities",
        "reminiscence_note" to "Every choice is beautiful and unique.",
        "favorite_marked" to "Added to favorites ❤️",
        "favorite_unmarked" to "Removed from favorites",
        "congratulations" to "Superb! Well done!",
    ...
    val hindiStrings = mapOf(
        ...
        "activities_completed_today" to "आज की पूरी की गई गतिविधियां",
        "recommended_today" to "आज का विशेष सुझाव",
        "tap_to_start" to "शुरू करने के लिए छुएं",
        "well_done_title" to "बहुत सुंदर प्रयास! ✨",
        "next_activity" to "अगली गतिविधि",
        "try_another_activity" to "अन्य गतिविधियां देखें",
        "i_remember_ready" to "मैंने देख लिया! तैयार हूँ ✨",
        "what_did_you_see" to "थाली में इनमें से कौन सी वस्तु थी?",
        "all_activities" to "सभी गतिविधियां",
        "reminiscence_note" to "आपकी हर पसंद बेहद सुंदर और खास है।",
        "favorite_marked" to "पसंदीदा में जोड़ा गया ❤️",
        "favorite_unmarked" to "पसंदीदा से हटाया गया",
        "congratulations" to "बहुत बढ़िया! शाबाश!",
    ...
    val gujaratiStrings = mapOf(
        ...
        "activities_completed_today" to "આજે માણેલી રમતો",
        "recommended_today" to "આજનો વિશેષ સુઝાવ",
        "tap_to_start" to "શરૂ કરવા માટે અડો",
        "well_done_title" to "ખૂબ સરસ પ્રયાસ! ✨",
        "next_activity" to "આગળની રમત",
        "try_another_activity" to "બીજી રમતો જુઓ",
        "i_remember_ready" to "મેં જોઈ લીધું! તૈયાર છું ✨",
        "what_did_you_see" to "ટ્રેમાં આમાંથી કઈ વસ્તુ હતી?",
        "all_activities" to "બધી રમતો",
        "reminiscence_note" to "તમારી દરેક પસંદગી ખૂબ સુંદર અને ખાસ છે.",
        "favorite_marked" to "પસંદીદામાં ઉમેરાયું ❤️",
        "favorite_unmarked" to "પસંદીદામાંથી દૂર કર્યું",
        "congratulations" to "ખૂબ સરસ! શાબાશ!",
